...
const PIPELINE_ID = 'pipe:sys:define-offchain-schema-v1';
const POLL_INTERVAL_MS = 2500;
const TIMEOUT_MS = 60_000;

/**
 * Deploy an offchain schema definition via ParamGateway.
 * Executes the pipeline then polls until all tasks are synced.
 */
export async function deployOffchainSchema(payload: unknown): Promise<DeployResult> {
