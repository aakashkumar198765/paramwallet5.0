...
export function useRbac({ platformRole, userTeams = [], matrix, state, subState = null, microState = null, startStateOwners = [], }) {
    ...
    const canInitiate = useMemo(() => canCreate(startStateOwners, effectiveRole), [startStateOwners, effectiveRole]);
